...
access(all) contract ExampleNFT: NonFungibleToken, ViewResolver {
    ...
    access(all) resource NFT: NonFungibleToken.INFT, ViewResolver.Resolver {
        ...
        return <-ExampleNFT.createEmptyCollection(nftType: Type<@Collection>())
    })
...
access(all) fun createEmptyCollection(): @{NonFungibleToken.Collection}{
 return <-create Collection() 
    ...
    ///
    access(all) resource Collection: ExampleNFTCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.Collection, NonFungibleToken.CollectionPublic, ViewResolver.ResolverCollection {
...
access(all) fun createEmptyCollection(): @{NonFungibleToken.Collection}{
 return <-create Collection() 
    ...
    init() {
        ...
        var _capForLinked1 = self.account.capabilities.storage.issue<&ExampleNFT.Collection>( self.CollectionStoragePath)
self.account.capabilities.publish(_capForLinked1 , at:self.CollectionPublicPath)

		...
		fun resolveView(_ view: Type): AnyStruct?{ 
			switch view{ 
				...
				case Type<MetadataViews.Royalties>():
					let royaltyReceiver: Capability<&{FungibleToken.Receiver}> = getAccount(TopShot.RoyaltyAddress()).capabilities.get<&AnyResource>(MetadataViews.getRoyaltyReceiverPublicPath())!

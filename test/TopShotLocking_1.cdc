...
access(all) contract TopShotLocking {
    ...
    access(all) fun isLocked(nftRef: &{NonFungibleToken.NFT}): Bool {
    ...
    access(all) fun getLockExpiry(nftRef: &{NonFungibleToken.NFT}): UFix64 {
    ...
    //
    access(all) fun getExpiry(tokenID: UInt64): UFix64? {
    ...
    //
    access(all) fun getLockedNFTsLength(): Int {
    ...
    access(all) fun AdminStoragePath() : StoragePath { return /storage/TopShotLockingAdmin}

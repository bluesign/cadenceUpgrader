...
contract TouchstoneSnowyGlobez: NonFungibleToken{ 
	...
	resource Administrator{ 
		...
		fun mintNFT(metadataId: UInt64, serial: UInt64, recipient: Address){ 
			...
			if let recipientCollection = getAccount(recipient).capabilities.get<&TouchstoneSnowyGlobez.Collection>(TouchstoneSnowyGlobez.CollectionPublicPath).borrow<&TouchstoneSnowyGlobez.Collection>(){ 

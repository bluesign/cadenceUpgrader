...
pub struct TokenInfo{
    ...
    pub init(name:String, symbol: String, verified: Bool, logoURI: String, extra: {String:AnyStruct}){
        self.name = name
        self.symbol = symbol
...
init(){
    self.FT = {
        "A.475755d2c9dccc3a.TeleportedSportiumToken": TokenInfo(
    ...
    "A.078a8129525775dd.GreenBitcoin": TokenInfo(
        name: "Green Bitcoin",
        symbol: "GBTC",
        verified: true,
    ...
    "A.231cc0dbbcffc4b7.ceBNB": TokenInfo(
    ...
    "A.348fe2042c8a70d8.MyToken": TokenInfo(
        name: "My Token",
        symbol: "MY",
        verified: true,
    ...
    "A.7120ab3fbf74ea9e.NCTRDAO": TokenInfo(
        name: "NCTR DAO",
        symbol: "NCTR",
        verified: true,
    ...
    "A.231cc0dbbcffc4b7.ceMATIC": TokenInfo(
    ...
    "A.142fa6570b62fd97.StarlyToken": TokenInfo(
        name: "Starly Token",
        symbol: "STARLY",
        verified: true,
    ...
    "A.48ff88b4ccb47359.Duckcoin": TokenInfo(
        name: "Duckcoin",
        symbol: "Duck",
        verified: true,
    ...
    "A.231cc0dbbcffc4b7.ceBUSD": TokenInfo(
    ...
    "A.231cc0dbbcffc4b7.ceWBTC": TokenInfo(
    ...
    "A.921ea449dffec68a.DustToken": TokenInfo(
        name: "Flovatar ÐUST",
        symbol: "DUST",
        verified: true,
    ...
    "A.d01e482eb680ec9f.REVV": TokenInfo(
        name: "REVV",
        symbol: "REVV",
        verified: true,
    ...
    "A.1654653399040a61.FlowToken": TokenInfo(
        name: "Flow",
        symbol: "FLOW",
        verified: true,
    ...
    "A.53f389d96fb4ce5e.SloppyStakes": TokenInfo(
        name: "Sloppy Stakes",
        symbol: "LOPPY",
        verified: true,
    ...
    "A.231cc0dbbcffc4b7.ceUSDT": TokenInfo(
    ...
    "A.7bf07d719dcb8480.brasil": TokenInfo(
        name: "brasil",
        symbol: "BR",
        verified: true,
    ...
    "A.3c5959b568896393.FUSD": TokenInfo(
        name: "Flow USD",
        symbol: "FUSD",
        verified: true,
    ...
    "A.231cc0dbbcffc4b7.ceDAI": TokenInfo(
    ...
    "A.d5dab99b4e7301ce.PublishedNFTDAO": TokenInfo(
    ...
    "A.4ea047c3e73ca460.BallerzFC": TokenInfo(
        name: "Ballerz FC",
        symbol: "BFC",
        verified: true,
    ...
    "A.231cc0dbbcffc4b7.ceWETH": TokenInfo(
    ...
    "A.d756450f386fb4ac.OzoneToken": TokenInfo(
        name: "Ozone Token",
        symbol: "Ozone",
        verified: true,
    ...
    "A.231cc0dbbcffc4b7.RLY": TokenInfo(
        name: "Rally",
        symbol: "RLY",
        verified: true,
    ...
    "A.0f9df91c9121c460.BloctoToken": TokenInfo(
        name: "Blocto Token",
        symbol: "BLT",
        verified: true,
    ...
    "A.231cc0dbbcffc4b7.ceAVAX": TokenInfo(
    ...
    "A.b19436aae4d94622.FiatToken": TokenInfo(
        name: "USD Coin",
        symbol: "USDC",
        verified: true,
    ...
    "A.cfdd90d4a00f7b5b.TeleportedTetherToken": TokenInfo(
    ...
    "A.d6f80565193ad727.stFlowToken": TokenInfo(
    ...
    "A.c8c340cebd11f690.SdmToken": TokenInfo(
        name: "Sdm Token",
        symbol: "SDM",
        verified: true,
    ...
    "A.231cc0dbbcffc4b7.ceFTM": TokenInfo(
        name: "Fantom (Celer)",
        symbol: "ceFTM",
        verified: true,

...
pub contract LogEntry {
    ...
    pub fun LogAggregateSwap(userAddr: Address, tokenInKey: String, tokenOutKey: String, tokenInAmount: UFix64, tokenOutAmount: UFix64, amountInSplitByPoolSource: {String: UFix64}, isExactAForB: Bool) {
    ...
    pub fun LogSweepTokensToFlow(tokensToSweep: [String], amountsToSweep: [UFix64], flowTokensOut: [UFix64]) {
        emit SweepTokensToFlow(tokensToSweep: tokensToSweep, amountsToSweep: amountsToSweep, flowTokensOut: flowTokensOut)
    }
    pub fun LogMigrateSwapLpFromV1ToV2(token0Key: String, token1Key: String, lpToRemove: UFix64, token0WithdrawFromV1: UFix64, token1WithdrawFromV1: UFix64, token0LeftAfterFirstAddV2Lp: UFix64, token1LeftAfterFirstAddV2Lp: UFix64, zappedAmount: UFix64) {
    ...
    pub fun LogBurnSwapLp(token0Key: String, token1Key: String, pairAddr: Address, amountToBurn: UFix64) {
